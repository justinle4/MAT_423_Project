...
def trainModel(myModel, cfg):
    ...
    for trial in range(5):
        ...
        # insert results into dataframe
            df.loc[epoch] = [epoch, np.mean(loss_train), np.mean(loss_test), accuracy_train, accuracy_test]
            print(f"Trial {trial+1}, Epoch {epoch + 1} complete")
